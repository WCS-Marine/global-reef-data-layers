# This is a very slighlty modified version of Marco Andrello's code in: 
# https://github.com/WCS-Marine/local-reef-pressures/blob/main/data/Transform_CRS.R
...
load(here("globalprep", "analysis", "coral-counterfactual","data_dl",
          "wcs-local-reef-pressures", "allreefs.Rdata"))
...
rgdal::writeOGR(as_Spatial(a_WGS84), 
                dsn = here::here("globalprep", "analysis", "coral-counterfactual","data_dl",
                           "wcs-local-reef-pressures"),
                layer = "allreefs_WGS84", 
...
allreefs <- a_WGS84
save(allreefs, file = here::here("globalprep", "analysis", "coral-counterfactual","data_dl",

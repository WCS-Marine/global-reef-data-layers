#--- 01-format-noaa-dhw-cumulative.R --------------#
...
# int n_gt0[lon,lat]   (Contiguous storage)  
# long_name: Number of events for which the thermal stress, measured by Degree Heating Weeks, exceeded 0 degC-weeks.
# units: counts
# valid_min: 5
# valid_max: 53
# coordinates: lon lat
# comment: The number of events for which the thermal stress, measured by Degree Heating Weeks, exceeded 0 degC-weeks.
# coverage_content_type: physicalMeasurement
# grid_mapping: crs

dhw <- ncvar_get(nc_data, "n_gt0")
dim(dhw)
